...
Develop a custom user storage provider which will take mobile number and otp in place of username and password and validate it against a mock service to provide access tokens.
